...
| Serverless rooms | QR/manual WebRTC handshake, multi-peer host, local replicated standings, diagnostics and exports | Run small competitions without hosted infrastructure | Signal validation and complete desktop/mobile peer exchange |

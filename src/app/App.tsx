  ...
  return (
    <div className={`shell${controlsOpen ? "" : " controls-closed"}`}>
      ...
      <Sidebar
        ...
        leaderboard={{entries:history,currentMazeId:mazeId,currentMaze:historyParams,currentGraph:mazeGraph,sharedEndpoint:import.meta.env.VITE_SHARED_LEADERBOARD_URL,onOpenMaze:applyMazeParams}}

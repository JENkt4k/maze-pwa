...
export type MicromouseBatchControls={count:BatchSeedCount;setCount:(count:BatchSeedCount)=>void;running:boolean;result:MicromouseBatchResult|null;error:string|null;shared:boolean;share:()=>void;run:()=>void;cancel:()=>void};

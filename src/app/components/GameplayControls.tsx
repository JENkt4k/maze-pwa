...
type Props={active:boolean;state:MazeGameState;breadcrumbs:boolean;setBreadcrumbs:(value:boolean)=>void;start:()=>void;pause:()=>void;restart:()=>void;hint:()=>void;newMaze:()=>void;shareChallenge:()=>void;difficulty:number;personalBestMs?:number};
